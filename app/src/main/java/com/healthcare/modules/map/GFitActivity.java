...
import com.healthcare.modules.service.GoogleFitService;
...
public class GFitActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gfit_activity);
    ...
    private void handleConnectButton() {
        try {
            authInProgress = true;
            mFitResultResolution.startResolutionForResult(GFitActivity.this, REQUEST_OAUTH);
    ...
    private BroadcastReceiver mFitDataReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.hasExtra(GoogleFitService.HISTORY_EXTRA_STEPS_TODAY)) {
                ...
                Toast.makeText(GFitActivity.this, "Total Steps: " + totalSteps, Toast.LENGTH_SHORT).show();
    ...
    private void fitHandleFailedConnection(ConnectionResult result) {
        ...
        if (!result.hasResolution()) {
            ...
            GooglePlayServicesUtil.getErrorDialog(result.getErrorCode(), GFitActivity.this, 0).show();
            return;
        }
        ...
        if (!authInProgress) {
            if (result.getErrorCode() == FitnessStatusCodes.NEEDS_OAUTH_PERMISSIONS) {
                try {
                    ...
                    result.startResolutionForResult(GFitActivity.this, REQUEST_OAUTH);
                } catch (IntentSender.SendIntentException e) {
