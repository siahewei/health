...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        kineticsDao.createTable(db, ifNotExists);
        locusDao.createTable(db, ifNotExists);
        dataentityDao.createTable(db, ifNotExists);
        stepbeanDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        kineticsDao.dropTable(db, ifExists);
        locusDao.dropTable(db, ifExists);
        dataentityDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(kineticsDao.class);
        registerDaoClass(locusDao.class);
        registerDaoClass(dataentityDao.class);
